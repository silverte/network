...
variable "tgw_attach_subnets_stg" {
...
variable "enable_nat_gateway_stg" {
...
variable "single_nat_gateway_stg" {
...
variable "enable_vpc_flow_log_stg" {
...
variable "vpc_flow_log_s3_arn_stg" {
