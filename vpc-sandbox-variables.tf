...
# VPC Public Subnets
variable "public_subnets_sandbox" {
...
# VPC Private Subnets
variable "private_subnets_sandbox" {
...
# VPC Infra Subnets
variable "endpoint_subnets_sandbox" {
...
variable "database_subnets_sandbox" {
...
variable "tgw_attach_subnets_sandbox" {
...
variable "enable_nat_gateway_sandbox" {
...
variable "single_nat_gateway_sandbox" {
...
variable "enable_vpc_flow_log_sandbox" {
...
variable "vpc_flow_log_s3_arn_sandbox" {
