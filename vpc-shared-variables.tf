...
# VPC Public Subnets
variable "public_subnets_shared" {
...
# VPC Infra Subnets
variable "endpoint_subnets_shared" {
...
variable "database_subnets_shared" {
...
variable "tgw_attach_subnets_shared" {
...
variable "enable_nat_gateway_shared" {
...
variable "single_nat_gateway_shared" {
...
variable "enable_vpc_flow_log_shared" {
...
variable "vpc_flow_log_s3_arn_shared" {
