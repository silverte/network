...
# VPC Public Subnets
variable "public_subnets_network" {
...
# VPC Private Subnets
variable "private_subnets_network" {
...
# VPC Infra Subnets
variable "endpoint_subnets_network" {
...
variable "database_subnets_network" {
...
variable "tgw_attach_subnets_network" {
...
variable "enable_nat_gateway_network" {
...
variable "single_nat_gateway_network" {
...
variable "enable_vpc_flow_log_network" {
...
variable "vpc_flow_log_s3_arn_network" {
